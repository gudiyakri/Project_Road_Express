...
demo = {
  ...
  showSwal: function(type) {
    if (type == 'basic') {
    ...
    else if (type == 'sos-sent') {
      swal({
        title: "Successfull!",
        text: "S.O.S Has Been Sent To Driver!",
        buttonsStyling: false,
        confirmButtonClass: "btn btn-success",
        type: "success"
      }).catch(swal.noop);
      ...
      swal({
        title: 'UnSuccessFull',
        text: "New Master OTP and Current Master OTP cannot be same",
  ...
  validVswal: function(type,v_id,id) {
    if (type == 'success-message') {
      swal({
        ...
        window.location.href = `/admin/updateV/${v_id}/${id}`;
      }).catch(swal.noop);
    }
  },
